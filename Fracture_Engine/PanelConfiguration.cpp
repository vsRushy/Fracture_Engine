...
PanelConfiguration::PanelConfiguration(bool start_enabled) : Module(start_enabled)
{
...
update_status PanelConfiguration::PreUpdate(float dt)
{
	return UPDATE_CONTINUE;
}

update_status PanelConfiguration::Update(float dt)
{
...
update_status PanelConfiguration::PostUpdate(float dt)
{
	/* Render ImGui */
	ImGui::Render();
